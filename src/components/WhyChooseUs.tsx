...
const WhyChooseUsData = [
  {
    icon: (
      <LockOpen1Icon className="text-pixelgo-text w-[20px] lg:w-[40px] h-[20px] lg:h-[40px]" />
    ),
    details: "Solutions Tailored Specifically to Your Business Needs",
  },
  {
    icon: (
      <Star className="text-pixelgo-text w-[20px] lg:w-[40px] h-[20px] lg:h-[40px]" />
    ),
    details: "Creative Excellence Elevates Every project",
  },
  {
    icon: (
      <PersonIcon className="text-pixelgo-text w-[20px] lg:w-[40px] h-[20px] lg:h-[40px]" />
    ),
    details: "Client Satisfaction Is Our Main Focus",
  },
  {
    icon: (
      <DoubleArrowUpIcon className="text-pixelgo-text w-[20px] lg:w-[40px] h-[20px] lg:h-[40px]" />
    ),
